...
class SignPoster extends AuthController
{
    ...
    public function create()
    {
        ...
        $f[] =Form::frameImageOne('poster', '签到海报(540*540)', Url::build('admin/widget.images/index', array('fodder' => 'poster')))->icon('image')->width('100%')->height('500px');
    ...
    public function edit($id)
    {
        ...
        $f[] =Form::frameImageOne('poster', '签到海报(540*540)', Url::build('admin/widget.images/index', array('fodder' => 'poster')),$poster->getData('poster'))->icon('image')->width('100%')->height('500px');
