...
class TeacherCategpry extends AuthController
{
    ...
    public function save($id = 0)
    {
        ...
        if ($id) {
            ...
            if(TeacherCategpryModel::where(['title'=>$post['title'],'is_del'=>0])->where('id','<>',$id)->count()>=1) return Json::fail('分类名称已存在');
            ...
            $post['add_time'] = time();
            if(TeacherCategpryModel::be(['title'=>$post['title'],'is_del'=>0])){
