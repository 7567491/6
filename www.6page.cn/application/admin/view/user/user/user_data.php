...
<style>
    ...
    .data .item .text{color: #10952a;cursor: pointer}
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-col-md-12 clearfix">
                        ...
                        <div class="layui-col-md6">
                           <div class="item item-right" @click="give"><button class="layui-btn layui-btn-normal">赠送课程</button></div>
                        </div>
                    </div>
                    <div class="layui-col-md-12 clearfix">
                        <div class="layui-col-md6">
                                                ...
                                                <table class="layui-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 11%">入账/结算</th>
                                                            <th style="width: 13%">记录说明</th>
