                    ...
                    <form action="" class="layui-form">
                        ...
                        <div class="layui-form-item submit">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="title" style="width: 50%" v-model.trim="formData.title" autocomplete="off" placeholder="请输入昵称" class="layui-input">
                            </div>
                        </div>
...
<!--                                </label>-->
<!--                                <div class="layui-input-block">-->
<!--                                    <div class="upload-image-box" v-if="formData.img" @mouseenter="mask.image = true" @mouseleave="mask.image = false">-->
...
<!--                            </div>-->
                        <div class="layui-form-item submit" v-show="!free || formData.free_day<0">
                            ...
                            <div class="layui-input-block">
                                <input type="number" name="original_price" min="0" style="width: 50%" v-model.number="formData.original_price" autocomplete="off"  class="layui-input">
                            </div>
                        </div>
                            <div class="layui-form-item submit" v-show="!free || formData.free_day<0">
                            <label class="layui-form-label">优惠后价格：</label>
                            <div class="layui-input-block">
                                <input type="number" name="price" min="0" style="width: 50%" v-model.number="formData.price" autocomplete="off"  class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item submit">
                            <label class="layui-form-label">排序：</label>
                            <div class="layui-input-block">
                                <input type="number" name="sort" min="0" style="width: 50%" v-model="formData.sort" autocomplete="off" class="layui-input" v-sort>
                            </div>
                        </div>
                        <div class="layui-form-item" >
        ...
        new Vue({
            ...
            methods:{
                ...
                save:function () {
                    ...
                    if (Number(that.formData.original_price) > 9999) {
                        return layList.msg('会员原价不能大于9999');
                    }
                    if(Number(that.formData.price) <0) return layList.msg('请输入会员优惠后价格');
                    if (Number(that.formData.price) > 9999) {
                        return layList.msg('会员优惠后价格不能大于9999');
                    }
