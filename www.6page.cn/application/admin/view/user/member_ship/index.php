        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">付费会员</div>
                </div>
                <div class="layui-card-body">
                    <div class="layui-btn-group">
                        ...
                        <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="openAdd()">
                            新增
                        </button>
                    </div>
    ...
    layList.tool(function (layEvent,data,obj) {
        switch (layEvent){
            case 'add':
                ...
                break;
            case 'edit':
                $eb.createModalFrame('修改会员设置',layList.U({a:'add_vip',q:{id:data.id}}),{w:800,h:600});
                break;
            case 'image':
