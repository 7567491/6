...
<style>
    ...
    .option .layui-box p{margin: 5px 0;background-color: #ffffff;color: #10952a;padding: 8px;cursor: pointer}
    .option .layui-box p.on{color: #eeeeee}
    .layui-table-cell img{width: 50px;height: 50px;max-width: 100%;cursor: pointer;}
</style>
{/block}
{block name="content"}
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="headimgurl">
                        <img lay-event='open_image' src="{{d.avatar}}">
                    </script>
...
<script>
    ...
    layList.tableList('userList',"{:Url('spread_list')}",function () {
        return [
            {field: 'uid', title: 'UID', align: 'center',width:'6%'},
            {field: 'avatar', title: '头像',templet:'#headimgurl',align: 'center',width:'6%'},
            {field: 'nickname', title: '用户信息',templet:'#userinfo'},
            {field: 'spread_count', title: '推广用户数量',sort:true,align: 'center',width:'8%'},
            {field: 'order_price', title: '推广订单金额',sort:true,align: 'center'},
            {field: 'order_count', title: '推广订单数量',align: 'center',width:'8%'},
            {field: 'brokerage_money', title: '佣金金额',sort:true,align: 'center',width:'8%'},
            {field: 'new_money', title: '未提现金额',sort:true,align: 'center',width:'8%'},
            {field: 'extract_count_price', title: '已提现金额',sort:true,align: 'center',width:'8%'},
            {field: 'extract_count_num', title: '提现次数',align: 'center',width:'8%'},
            {field: 'spread_name', title: '上级推广人',sort:true,align: 'center'},
            {field: 'right', title: '操作',toolbar:'#act',align: 'center',width:'6%'},
        ];
    });
