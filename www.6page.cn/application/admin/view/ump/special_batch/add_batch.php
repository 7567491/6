            ...
            <div class="layui-col-md12">
                <div class="layui-card" v-cloak="">
                    ...
                    <div class="layui-card-body" style="padding: 10px 150px;">
                        ...
                        <div class="layui-form-item required">
                            <label class="layui-form-label">课程课程：</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-form-item m-t-5 required">
                ...
                <div class="layui-col-md12">
                    <div class="layui-form-item submit" style="margin-bottom: 10px;text-align: center">
                        <div class="layui-input-block">
        ...
        new Vue({
            ...
            methods:{
                save:function () {
                    ...
                    if(!that.formData.special_id) return layList.msg('请选择课程');
