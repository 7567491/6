    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <form class="layui-form" action="">
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" v-model.trim="formData.title">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline" style="width: 300px;">
                                        <input type="text" class="layui-input" autocomplete="off" id="date1">
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline" style="width: 300px;">
                                        <input type="text" class="layui-input" autocomplete="off" id="date2">
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" required lay-verify="required" min="1" autocomplete="off" class="layui-input" v-model.number="formData.number">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                            ...
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="detail" required lay-verify="required" placeholder="请输入详细地址" autocomplete="off" class="layui-input" v-model="formData.detail">
                                </div>
                            </div>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <script id="editor1" name="content1" type="text/plain">{{ formData.activity_rules }}</script>
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                <label class="layui-form-label">活动详情：</label>
                                <div class="layui-input-block">
                                    <script id="editor2" name="content2" type="text/plain">{{ formData.content }}</script>
                                </div>
                            </div>
                        </div>
                        <div class="layui-tab-item">
                                ...
                                <div v-for="(item, index) in event" :key="index" class="layui-form-item event">
                                    <div class="layui-input-block">
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input v-model.trim="item.event_name" type="text" placeholder="请输入标题" maxlength="4" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                            ...
                            <div v-for="(item, index) in price" class="layui-form-item price">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input v-model.trim="item.event_number"  type="text" autocomplete="off" class="layui-input" @change="peopleChange(item)">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button type="button" class="layui-btn layui-btn-normal" lay-submit lay-filter="submit">{$id ? '确认修改':'立即提交'}</button>
        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                peopleChange: function (item) {
                    ...
                    eventNumber = isNaN(eventNumber) ? 1 : Math.abs(eventNumber);
                    // if (eventNumber < 2) {
                    //     eventNumber = 2;
                    // }
                ...
                this.$nextTick(function () {
                    ...
                    layui.use([
                        ...
                        form.on('submit(submit)', function () {
                            ...
                            var activity_rules = vm.editor1.getContent();
                            var content = vm.editor2.getContent();
                            if (!formData.signup_start_time) {
                                layer.msg('请选择报名时间');
                            } else if (!formData.start_time) {
                                layer.msg('请选择活动时间');
                            } else if (formData.number <= 0 || parseInt(formData.number) !== parseFloat(formData.number)) {
                                ...
                                if (vm.verifyFormEvent(formData)) {
                                    for (var i = 0, len = vm.price.length; i < len; i++) {
                                        if (vm.price[i].event_number > vm.formData.number) {
                                            layer.msg('价格设置中输入的人数不能大于输入的活动人数');
                                            return;
                                        }
                                    }
                                    if (!vm.priceVerify) {
                                        layer.msg('请检查价格设置中的价格或会员价格');
                                        return;
                                    }
                    ...
                    for (var i = scripts.length; i--;) {
                        ...
                        this[scriptId] = UE.getEditor(scriptId);
                    }
