        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">文章列表</div>
                </div>
                    ...
                    <div class="layui-row layui-col-space15">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group">
                                <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" onclick="action.open_add('{:Url('add_article',['type'=>2])}','添加文章')">
                            ...
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    <li>
                                        <a  href="javascript:void(0)" onclick="action.open_add('{:Url('add_article',['type'=>2])}?id={{d.id}}','文章编辑')">
                                            <i class="fa fa-paste"></i> 编辑文章
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.title}}-推荐管理','{:Url('mp_recommend')}?article_id={{d.id}}',{h:300,w:400})">
                                            <i class="fa fa-check-circle"></i> 推至小程序首页
                                        </a>
                                    </li>
                                    <li>
        ...
        o: 'List',
            ...
            $('.layui-btn-mp').on('click', function (event) {
                ...
                if ('recommend' === type) {
                    var id = target.dataset.id;
                    var pid = target.dataset.pid;
                    var url = layList.U({ a: 'cancel_mp_recommendation', q: { id: id, article_id: pid } });
                    $eb.$swal(
                        'delete',
                        function () {
                            $eb.axios
