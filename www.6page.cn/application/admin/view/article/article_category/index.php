                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        ...
                                        <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" style="background-color:#10952a;" onclick="window.location.reload()">
...
<script>
    ...
    var active = {
        add: function () {
            $eb.createModalFrame('添加文章分类', "{:Url('create')}");
        },
        edit: function () {
            var _this = $(this),
                id =_this.data('id');
