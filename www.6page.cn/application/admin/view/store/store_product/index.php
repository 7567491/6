                    ...
                    <div class="layui-row layui-col-space15">
                        ...
                        <div class="layui-col-md12">
                            ...
                            <script type="text/html" id="recommend">
                                ...
                                <span class="layui-badge layui-bg-blue recom-item" data-id="{{index}}" data-pid="{{d.id}}" style="margin-bottom: 5px;">yd:{{item}}</span>
                                {{#  }); }}
                                {{#  layui.each(d.mp_recommend, function(index, item){ }}
                                <span class="layui-badge layui-bg-blue recom-item-mp" data-id="{{index}}" data-pid="{{d.id}}" style="margin-bottom: 5px;">mp:{{item}}</span>
                                {{#  }); }}
                            </script>
                            <!--操作-->
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    ...
                                    <li>
                                        <a  href="javascript:void(0)" onclick="action.open_add('{:Url('knowledge')}?id={{d.id}}','关联课程')">
                                            <i class="layui-icon layui-icon-set"></i> 关联课程
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.store_name}}-推荐管理','{:Url('recommend')}?product_id={{d.id}}',{h:300,w:400})">
                                            <i class="iconfont icon-tuijianshouye"></i> 推荐至移动首页
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.store_name}}-推荐管理','{:Url('mp_recommend')}?product_id={{d.id}}',{h:300,w:400})">
                                            <i class="iconfont icon-tuijianshouye"></i> 推荐至小程序首页
                                        </a>
                                    </li>
                                    {{# if(d.is_del){ }}
                                    <li>
...
<script>
        ...
        switch (parseInt(type)){
            case 1:case 3:case 4:case 5:
                join=[
                    ...
                    {field: 'status', title: '状态',templet:"#checkboxstatus",align: 'center',width:'6%'},
    ...
    $(function () {
        ...
        $(document).on('click', '.recom-item-mp', function () {
            var that = this;
            var url = layList.U({ a: 'cancel_mp_recommendation', q: { id: that.dataset.id, product_id: that.dataset.pid } });
            $eb.$swal(
                'delete',
                function () {
                    $eb.axios
