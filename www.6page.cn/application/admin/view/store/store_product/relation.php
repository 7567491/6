                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" autocomplete="off" class="layui-input" name="title" id="demoReload" placeholder="请输入课程名称">
                                </div>
                            </div>
                            <div class="layui-inline">
...
<script>
    ...
    table.render({
        elem: '#List'
        ,url:"{:Url('admin/special.special_type/source_list')}?special_id="+id+"&special_type=8"
        ,cols: [[
            {type: 'checkbox'},
            {field: 'id', title: '编号', width:60,align: 'center'},
            {field: 'types', title: '类型',align: 'center'},
            {field: 'is_light', title: '课程类别',templet:'#is_light',align:'center'},
            {field: 'title', title: '课程标题',align: 'center'},
