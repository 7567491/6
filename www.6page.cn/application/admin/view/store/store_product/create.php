                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="store_name" v-model.trim="formData.store_name" autocomplete="off" placeholder="请输入产品名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                            ...
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <div class="upload-image-box" v-if="formData.slider_image.length" v-for="(item,index) in formData.slider_image" @mouseenter="enter(item)" @mouseleave="leave(item)">
                                    ...
                                    <div class="upload-image" v-show="formData.slider_image.length <= 3" @click="upload('slider_image',5)">
                                        <div class="fiexd"><i class="fa fa-plus"></i></div>
                                        <p>选择图片</p>
                                    </div>
                                </div>
            ...
            methods: {
                ...
                save: function () {
                    ...
                    if (that.formData.member_pay_type == 1) {
                        if (that.formData.vip_price<0 || that.formData.vip_price <0) return layList.msg('请填写会员购买金额');
                    }
