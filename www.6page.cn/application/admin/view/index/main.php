        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日新增学员</div>
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日学习次数</div>
                    <div class="layui-card-body layuiadmin-card-list">
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日课程订单</div>
                    <div class="layui-card-body layuiadmin-card-list">
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日课程收入</div>
                    <div class="layui-card-body layuiadmin-card-list">
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日商品订单</div>
                    <div class="layui-card-body layuiadmin-card-list">
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日商品收入</div>
                    <div class="layui-card-body layuiadmin-card-list">
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日新增会员</div>
                    <div class="layui-card-body layuiadmin-card-list">
            ...
            <div class="layui-col-md3">
                <div class="layui-card">
                    <div class="layui-card-header">今日会员充值</div>
                    <div class="layui-card-body layuiadmin-card-list">
                            ...
                            <div class="layui-col-md9">
                                <div class="layui-card">
                                    <div class="layui-card-header">
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '0'}" @click="getlisttype('0')">课程</button>
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '1'}" @click="getlisttype('1')">会员</button>
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '2'}" @click="getlisttype('2')">商城</button>
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '3'}" @click="getlisttype('3')">资料</button>
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '4'}" @click="getlisttype('4')">考试</button>
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '5'}" @click="getlisttype('5')">报名</button>
                                        <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" :class="{'normal': type == '6'}" @click="getlisttype('6')">充值</button>
                                    </div>
                                    <div class="layui-card-body">
