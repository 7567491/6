                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入课程名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item required">
...
<!--                            </div>-->
                            ...
                            <div class="layui-form-item required">
                                ...
                                <div class="layui-input-block">
                                    <script id="editor" name="content" type="text/plain">{{formData.content}}</script>
                                </div>
                            </div>
                        </div>
                        <div class="layui-tab-item">
                            <div class="layui-form-item required">
                                <label class="layui-form-label">课节选择：</label>
                                <div class="layui-input-block">
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" v-show="formData.pay_type == 1">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="money" lay-verify="number" v-model="formData.money" autocomplete="off" class="layui-input" min="0">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item" v-show="formData.is_fake_pink && formData.is_pink">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" v-model="formData.fake_pink_number" autocomplete="off" class="layui-input" min="0">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    require(['vue', 'zh-cn', 'request', 'plupload', 'aliyun-oss', 'OssUpload'], function (Vue) {
        new Vue({
            ...
            methods: {
                onSortBlur: function () {
                    var val = parseInt(this.formData.sort);
                    if (isNaN(val)) {
                ...
                show_source_list: function () {
                    ...
                    table.render({
                        ...
                        cols: [[
                            ...
                            {field: 'title', title: '课节标题', edit: 'title', align: 'center'},
                            {
                                field: 'image',
                                title: '封面',
