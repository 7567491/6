...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15"  id="app">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-inline">
                        <input class="layui-input" name="title" id="demoReload" placeholder="请输入课节名称">
                    </div>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">{$special_title}课节列表</div>
                <div class="layui-card-body">
...
<script>
    ...
    table.render({
        ...
        ,cols: [[
            ...
            {field: 'title', title: '素材标题',align:'center'},
