            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container conrelTable">
                        <button class="layui-btn layui-btn-normal layui-btn-sm" type="button" onclick="action.open_add('{:Url('relation')}?id='+{$id}+'&relationship='+relationship,'添加试题')">
                            选择{$relationship==1 ? '练习' : '考试'}试卷
                        </button>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList({o:'List', done:function () {}},"{:Url('getRelationTestPaperList')}?id="+id+"&relationship="+relationship,function (){
        return [
