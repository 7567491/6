        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">课节列表</div>
                </div>
                    ...
                    <div class="layui-row layui-col-space15">
                            ...
                            <form class="layui-form layui-form-pane" action="">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="title" class="layui-input" placeholder="请输入课节名称">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <div class="layui-input-inline">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group">
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" data-type="add" onclick="action.open_add('{:Url('admin/special.special_type/addSources')}','添加课节')">
                                    <i class="layui-icon">&#xe608;</i>添加课节
                                </button>
                            ...
                            <script type="text/html" id="is_pay_status_c">
                                ...
                                <a onclick="$eb.createModalFrame('设置收费课程','{:Url('is_pay_status_c')}?id='+{{d.id}},{w:800})" class="layui-btn layui-btn-normal layui-btn-xs">已设置</a>
                                {{# }else if(d.use>0){ }}
...
<script>
    ...
    layList.tableList({
        ...
        return [
            ...
            {field: 'title', title: '课节名称',align: 'center',width:'16%'},
            {field: 'types', title: '课节类型',align: 'center',width:'8%'},
            {field: 'image', title: '课节封面',templet:'#image',align: 'center',style:'height:auto',width:'10%'},
            {field: 'use', title: '应用次数',align: 'center',width:'8%'},
            {field: 'is_pay_status_c', title: '是否设置收费',align: 'center',templet:'#is_pay_status_c',width:'8.3%'},
            {field: 'recommend', title: '移动端推荐',templet:'#recommend',align: 'center',width:'16%'},
    ...
    var action= {
        ...
        del_all: function () {
            ...
            ids = ids.join(',');
            var url=layList.U({a:'delete',q:{id: ids, model_type:'task'}});
                ...
                if (value.trim()) {
                    if (isNaN(value.trim())) {
                        ...
                        if (value.trim() < 0) {
                            ...
                            action.set_value('sort', id, value.trim(), 'task');
                        }
                    }
                } else {
                    layList.msg('排序不能为空');
