                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" autocomplete="off" class="layui-input" name="title" id="demoReload" placeholder="请输入资料名称">
                                </div>
                            </div>
                            <div class="layui-inline">
...
<script>
    ...
    table.render({
        elem: '#List'
        ,url:"{:Url('admin/special.special_type/getDataDownloadList')}?data_id="+id+"&relationship="+relationship
        ,cols: [[
            {type: 'checkbox'},
