        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">课节分类</div>
                </div>
                            ...
                            <form class="layui-form layui-form-pane" action="">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        <label class="layui-form-label">课节分类名称</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="cate_name" class="layui-input" placeholder="请输入课节分类名称">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <div class="layui-input-inline">
...
<script>
    ...
    layui.config({
        ...
        $('.layui-btn').on('click', function(event) {
            ...
            if (type === 'add') {
                $eb.createModalFrame('添加课节分类', '{:Url('create')}',{ h: 500 ,w: 800 });
