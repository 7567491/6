        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">套餐课</div>
                </div>
                    ...
                    <div class="layui-row layui-col-space15">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="store_name" class="layui-input" placeholder="套餐课名称、简介、编号">
                        ...
                        <div class="layui-col-md12">
                            ...
                            <script type="text/html" id="is_mer_visible">
                                <input type='checkbox' name='id' disabled lay-skin='switch' value="{{d.id}}" lay-filter='is_mer_visible' lay-text='是|否'  {{ d.is_mer_visible == 1 ? 'checked' : '' }}>
                            </script>
                            ...
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    <li>
                                        <a href="javascript:void(0)" onclick="action.open_add('{:Url('add')}?id={{d.id}}&special_type={$special_type}','编辑课程')" >
...
<script>
    ...
    layList.tableList({o:'List', done:function () {
        ...
        return [
            ...
            {field: 'fake_sales', title: '虚拟人数',event:'fake_sales',edit:'fake_sales',align: 'center',width:'6%'},
            {field: 'sum', title: '课程数量',align: 'center',width:'6%'},
            ...
            {field: 'is_show', title: '状态',templet:'#is_show',align: 'center',width:'6%'},
            {field: 'is_mer_visible', title: '仅会员可见',templet:'#is_mer_visible',align: 'center',width:'6%'},
            {title: '操作',align:'center',toolbar:'#act',width:'6%'},
        ];
    });
    //下拉框
