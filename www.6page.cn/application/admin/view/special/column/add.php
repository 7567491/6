                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item required">
                                <label class="layui-form-label">套餐课名称：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入套餐课名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item required">
                            ...
                            <div class="layui-form-item required">
                                <label class="layui-form-label">套餐课简介：</label>
                                <div class="layui-input-block">
                                    <textarea placeholder="请输入套餐课简介" v-model="formData.abstract" class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">套餐课排序：</label>
                                <div class="layui-input-inline">
                                    <input type="number" name="sort" v-model="formData.sort" autocomplete="off" min="0" class="layui-input" v-sort>
                                </div>
                            </div>
                            <div class="layui-form-item required">
                                <label class="layui-form-label">套餐课标签：</label>
                                <div class="layui-input-inline">
...
<!--                            </div>-->
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                ...
                                <p style="color: red;">有效期为用户购买后可以观看时间，0为时间不限；【注：专栏设置有效期后，下列选择的课程的有效期会和专栏保持一致，请谨慎设置】</p>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <div class="layui-form-mid layui-word-aux" style="float: none;display: inline-block;">如课程列表中没有，可点击此添加</div>
                                    <br/>
                                    <p style="color: red;">注：选择的课程付费方式需要和套餐课的付费方式保持一致,如：专栏是会员免费，则选择的课程也需要设置成会员免费；若未设置则会被强制修改。</p>
                                </div>
                            </div>
                            <div class="layui-form-item">
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                ...
                                <p style="color: red;">注："所有人"都可观看的专栏下不能加"仅会员"可见的课程。</p>
                            </div>
                            <div class="layui-form-item">
        ...
        new Vue({
            ...
            methods: {
                ...
                save: function () {
                    ...
                    if (Object.keys(that.formData.check_source_sure).length == 0) return layList.msg('请选择课程');
