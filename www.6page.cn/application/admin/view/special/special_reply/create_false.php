        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">虚拟评价</div>
                </div>
                <div class="layui-card-body">
                    <form action="" class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label required">课程课程:</label>
                                <div class="layui-input-inline">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="satisfied_score" v-model="formData.satisfied_score" lay-search="" lay-filter="satisfied_score" lay-verify="required">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <div class="upload-image-box" v-if="formData.pics.length" v-for="(item,index) in formData.pics" @mouseenter="enter(item)" @mouseleave="leave(item)">
                                    ...
                                    <div class="upload-image" v-show="formData.pics.length <= 3" @click="upload('pics',5)">
                                        <div class="fiexd"><i class="fa fa-plus"></i></div>
                                        <p>选择图片</p>
                                    </div>
                                </div>
    ...
    require(['vue','helper','zh-cn','request','plupload','aliyun-oss','OssUpload'],function(Vue,$h) {
        new Vue({
            ...
            methods:{
                ...
                save:function () {
                    ...
                    that.$nextTick(function () {
                        ...
                        if (that.formData.special_id<=0) return layList.msg('请选择课程');
            ...
            mounted:function () {
                ...
                layList.select('satisfied_score', function (obj) {
                    that.formData.satisfied_score = obj.value;
                });
            }
        })
    })
