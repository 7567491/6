...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15"  >
        <div class="layui-col-md12" id="app" v-cloak="">
            ...
            <!--end-->
            <!-- 中间详细信息-->
            <div :class="item.col!=undefined ? 'layui-col-sm'+item.col+' '+'layui-col-md'+item.col:'layui-col-sm6 layui-col-md4'" v-for="item in badge" v-cloak="" v-if="item.count > 0">
                <div class="layui-card">
...
<script>
    ...
    layList.tableList('userList',"{:Url('lecturer_order_list')}?lecturer_id={$lecturer_id}",function () {
        return [
            ...
            {field: 'title', title: '课程名称',width:'21%',align: 'center'},
            {field: 'total_price', title: '课程价格',width:'10%',align: 'center'},
