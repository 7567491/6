        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">讲师列表</div>
                </div>
                    ...
                    <div class="layui-row layui-col-space15">
                        ...
                        <div class="layui-col-md12">
                            ...
                            <script type="text/html" id="lecturer_head">
                                <img style="cursor:pointer;" height="50" lay-event='open_image' src="{{d.lecturer_head}}">
                            </script>
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" lay-event='statistic'>
                                            <i class="iconfont icon-dingdantongji"></i> 订单统计
                                        </a>
                                    </li>
<!--                                    <li>-->
...
<script>
    ...
    layList.tableList({o:'List', done:function () {
        ...
        return [
            ...
            {field: 'lecturer_name', title: '名称',align: 'center'},
            {field: 'lecturer_head', title: '头像',templet:'#lecturer_head',align:'center'},
            {field: 'recommend', title: 'pc推荐',templet:'#recommend',align: 'center'},
            {field: 'curriculum', title: '课程数量',align:'center'},
            {field: 'study', title: '学习次数',align:'center'},
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            ...
            case 'statistic':
                layer.open({
                    type: 2,
                    title: data.lecturer_name + '—订单统计',
                    content: '{:Url('lecturer_order')}?id=' + data.id,
                    area: ['100%', '100%'],
                    maxmin: true
                });
                break;
