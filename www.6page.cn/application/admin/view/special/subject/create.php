                    ...
                    <form action="" class="layui-form" lay-filter="form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="checkbox" name="is_show" lay-skin="switch" lay-text="显示|隐藏" lay-filter="is_show" value="1">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
        ...
        new Vue({
            ...
            data: {
                ...
                formData:{
                    ...
                    is_show: Array.isArray(cate) ? 0 : cate.is_show
                },
