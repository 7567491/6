...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{__PUBLIC_PATH}wap/font/iconfont.css"/>
    <link rel="stylesheet" type="text/css" href="{__PUBLIC_PATH}wap/css/style.min.css?2"/>
    ...
    <script type="text/javascript" src="{__PUBLIC_PATH}wap/js/common.js"></script>
</head>
<body>
...
<div class="user-order-logistics" style="overflow: hidden;">
    <section>
        <div class="product-info flex">
            <div class="picture"><img src="{__PUBLIC_PATH}wap/images/express_icon.jpg"/></div>
        ...
        <div class="logistics-info" style="background-color: inherit;">
            <?php if(!$express || $express['status'] != 0){ ?>
                <div class="empty">
                    <img src="{__PUBLIC_PATH}wap/images/empty_address.png">
                    <p>暂无查询记录</p>
                </div>
            <?php }else{ ?>
                <ul class="flex">
