                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('订单记录','{:Url('order_status')}?oid={{d.id}}')">
                                    <i class="iconfont icon-dingdanxiangqing"></i> 订单记录
                                </a>
                            </li>
                            <li>
...
{block name="script"}
<script>
    layList.tableList('List',"{:Url('order_list',['real_name'=>$real_name,'types'=>1])}",function (){
        return [
            {field: 'order_id', title: '订单号', width:'12%',templet:'#order_id'},
        ...
        new Vue({
            ...
            data: {
                ...
                orderStatus: [
                    ...
                    {name: '已退款', value: -2,count:orderCount.yt,class:true},
                ],
                dataList: [
                    {name: '全部', value: ''},
                ...
                orderType:[
                    {name: '会员订单', value: 9,count:orderCount.vip,class:true},
                ],
                where:{
                    data:'',
                    status:'',
