                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            {{# if(d.typesetting!=5){ }}
                                ...
                                {{# }else if(d.type==11 || d.type==12 || d.type==14){ }}
                                <li>
                                    <a href="javascript:;" onclick="$eb.createModalFrame('{{d.title}}-'+this.innerText,'{:Url('recemmend_test_content')}?id={{d.id}}')">
                                        <i class="fa fa-list-ul"></i> 内容管理
                                    </a>
                                </li>
                                {{# }else if(d.type==4){ }}
                                <li>
                                    <a href="javascript:;" onclick="$eb.createModalFrame('{{d.title}}-'+this.innerText,'{:Url('recemmend_store_content')}?id={{d.id}}')">
                                        <i class="fa fa-list-ul"></i> 内容管理
                                    </a>
                                </li>
                                {{# }else{ }}
                                ...
                                {{# } }}
                                {{# if(d.type !=11 && d.type !=12 && d.type !=14){ }}
                                <li>
