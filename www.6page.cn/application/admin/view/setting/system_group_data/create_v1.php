        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div>排序第一的背景图推荐尺寸180*170，剩余2个推荐尺寸200*80</div>
                    <form class="layui-form" action="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="type" lay-filter="type" value="0" title="课程" {if isset($data)}{if
                        ...
                        <div class="layui-form-item submit">
                            <label class="layui-form-label">背景图：（左：180*170，右：200*80）</label>
...
<script>
    ...
    Help.getTypeHtml = function (type) {
        $('#select').html('');
        var name = 'select_id';
        var html = '<label class="layui-form-label">请选' + (type == 1 ? '分类' : '课程') + '</label>\n' +
            '                            <div class="layui-input-block">\n' +
