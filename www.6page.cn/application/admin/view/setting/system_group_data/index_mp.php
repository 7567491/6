        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">小程序首页活动</div>
                </div>
                                ...
                                <form class="layui-form" lay-filter="formswitch" action="">
                                    <div class="layui-form-item">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type='checkbox' name='state' class="test" lay-skin='switch'  lay-filter='mp_is_show_or_hide' lay-text='显示|隐藏'>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
{block name="script"}
<script>
    var mp_is_show_or_hide={$mp_is_show_or_hide};
    //实例化form
    layList.form.render();
    layList.form.val('formswitch',{
        state: mp_is_show_or_hide == 1 ? true : false
    })
    //加载列表
    ...
    layList.form.on('switch(mp_is_show_or_hide)',function (data) {
        layList.baseGet(layList.Url({
            a: 'mp_is_show_or_hide',
