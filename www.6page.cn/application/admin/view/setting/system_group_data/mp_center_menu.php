    ...
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-group">
                        <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="$eb.createModalFrame('添加我的服务菜单','{:Url('create_mp_recommend_custom')}?is_fixed=2')"><i class="layui-icon">&#xe608;</i>添加我的服务菜单</button>
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <div onclick="$eb.createModalFrame('{{d.title}}-'+this.innerText,'{:Url('create_mp_recommend_custom')}?id={{d.id}}&is_fixed=2')">
...
<script>
    ...
    var gid="{$gid}";
    //加载列表
    layList.tableList('List',"{:Url('mp_recommend_list',['is_fixed' => 2])}",function (){
        return [
    ...
    function delete_menu(id) {
        var url=layList.U({a:'delete_mp_recomm',q:{id:id}});
