...
<script>
    //加载列表
    layList.tableList('List',"{:Url('mp_recommend_content',['id'=>$id])}",function (){
        return [
            {field: 'type_name', title: '类型',align: 'center'},
            {field: 'title', title: '标题',align: 'center'},
            {field: 'count', title: '视频总数',align: 'center'},
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delete':
                var url=layList.U({a:'mp_recommend_delete',q:{id:data.id}});
