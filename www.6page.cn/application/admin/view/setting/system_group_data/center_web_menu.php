            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-btn-container">
                        <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="$eb.createModalFrame('添加pc端导航','{:Url('create_web_recemmend_custom')}?is_fixed=1')">
                            <i class="layui-icon">&#xe608;</i> 添加PC端导航
                        </button>
                ...
                <div class="layui-col-md12">PC端首页导航【注：PC端前端最多显示8条，倒序获得前8条】</div>
                <div class="layui-col-md12">
