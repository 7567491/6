...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList({o:'List', done:function () {}},"{:Url('broadcast_list')}",function (){
        return [
    ...
    $('.configuring').click(function () {
        ...
        layer.tips('<div style="color: #10952a;margin-top: 5px;">解析推流域名:'+domain_name+'</div> '+
            '<div style="color: #10952a;margin-top: 5px;">解析域名为:'+arr[0]+'</div>'+
            '<div style="color: #10952a;margin-top: 5px;">解析值为:</div>'+
            '<div style="color: #10952a;margin-top: 5px;">'+cname+'</div>'+
            '<div style="color: #10952a;margin-top: 5px;">解析类型为: CNAME</div>', '.configuring'+id);
    });
