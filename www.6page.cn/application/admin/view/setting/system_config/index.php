                    ...
                    <div class="layui-tab-item layui-show">
                        <div class="layui-row layui-col-space15">
                            <div class="layui-col-md12">
                                ...
                                <div>若没有配置对象存储Bucket，请到[<b style="color: #20a53a;">系统设置</b>]-[<b style="color: #20a53a;">阿里云</b>]里配置[<a href="{:Url('admin/setting.system_bucket/index')}" style="color: #20a53a;">对象存储</a>]</div>
                                {elseif condition="$tab_id eq '21'"/}
                                <div>若没有配置阿里云直播域名，请到[<b style="color: #20a53a;">系统设置</b>]-[<b style="color: #20a53a;">阿里云</b>]里配置[<a href="{:Url('admin/setting.system_broadcast/index')}" style="color: #20a53a;">直播配置</a>]</div>
                                {/if}
                            </div>
                            <div class="layui-col-md12">
