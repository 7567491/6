            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-row layui-col-space15">
                        <div class="layui-col-md12">
                            <div class="layui-card-header">
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm synchro">
                                    同步微信模版消息
                                </button>
...
<script>
    ...
    layList.tableList({o:'List', done:function () {}},"{:Url('system_message_list')}",function (){
        return [
            ...
            {field: 'is_sms', title: '发送短信',templet:'#is_sms',align: 'center',width:'10%'},
