                ...
                <div class="layui-row layui-col-space15">
                    <div class="layui-col-md12">
                        ...
                        <script type="text/html" id="fileListtool">
                            <button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="import"><i class="layui-icon layui-icon-edit"></i>导入</button>
...
<script>
    ...
    layui.use(['table', 'layer'], function(){
        ...
        fileList.on('tool(fileList)', function(obj){
            ...
            switch (layEvent){
                case 'import':
                    layer.confirm('真的导入该备份吗？', function(index){
