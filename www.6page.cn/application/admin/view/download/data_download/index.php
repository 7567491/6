        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">课件资料列表</div>
                </div>
                <div class="layui-card-body">
                    <div class="layui-row layui-col-space15">
                            ...
                            <form class="layui-form layui-form-pane" action="">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        <label class="layui-form-label">课件资料搜索</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="title" class="layui-input" placeholder="课件资料名称、简介、编号">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <label class="layui-form-label">课件资料分类</label>
                                        <div class="layui-input-inline">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group">
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" data-type="add" onclick="action.open_add('{:Url('add')}','添加课件资料')">
                                    <i class="layui-icon">&#xe608;</i>添加课件资料
                                </button>
                            ...
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    <li>
                                        <a  href="javascript:void(0)" onclick="action.open_add('{:Url('add')}?id={{d.id}}','编辑课件资料')">
                                            <i class="iconfont icon-bianji"></i> 编辑课件资料
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.title}}-推荐管理','{:Url('mp_recommend')}?data_id={{d.id}}',{h:300,w:400})">
                                    ...
                                    <li>
                                        <a lay-event='delect' href="javascript:void(0)">
                                            <i class="iconfont icon-shanchu"></i> 删除课件资料
                                        </a>
                                    </li>
                                </ul>
                            </script>
...
<script>
    ...
    layList.tableList({o:'List', done:function () {
        ...
        $('.layui-btn').on('mouseout', function (event) {
            ...
            $('.layui-btn-mp').on('click', function (event) {
                ...
                if ('recommend' === type) {
                    var id = target.dataset.id;
                    var pid = target.dataset.pid;
                    var url = layList.U({ a: 'cancel_mp_recommendation', q: { id: id, data_id: pid } });
                    $eb.$swal(
                        'delete',
                        function () {
                            $eb.axios
        ...
        return [
            ...
            {field: 'sales', title: '下载量',align: 'center',width:'8%'},
    ...
    var action= {
        ...
        del_all: function () {
            ...
            ids = ids.join(',');
            var url=layList.U({a:'delete',q:{id: ids}});
