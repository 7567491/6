...
<script>
    ...
    },"{:Url('live_store_list',['live_id'=>$live_id])}",function (){
        return [
            {field: 'live_goods_id', title: '编号', sort: true,event:'live_goods_id',width:'8%',align: 'center'},
            {field: 'store_name', title: '商品名称',align: 'center'},
            {field: 'cate_name', title: '所属分类',align: 'center'},
            {field: 'image', title: '封面图',templet:'#image',align: 'center'},
            {field: 'gsales', title: '实际销量',align: 'center'},
            {field: 'gfake_sales', title: '虚拟销量',edit:'gfake_sales',align: 'center'},
