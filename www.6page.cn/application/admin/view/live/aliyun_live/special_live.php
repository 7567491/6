...
<style>
    ...
    .go-live .live-box .live-text{font-size: 15px;color: #10952a;margin: 5px;padding: 10px 0;}
                        ...
                        <div class="layui-col-md12">
                            ...
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('{{d.title}}-推荐管理','{:Url('special.special_type/mp_recommend')}?special_id={{d.id}}',{h:300,w:400})">
...
<script>
    ...
    layList.tableList({o:'List', done:function () {
        ...
        $('.layui-btn').on('mouseout', function (event) {
            ...
            $('.layui-btn-mp').on('click', function (event) {
                ...
                if ('recommend' === type) {
                    var id = target.dataset.id;
                    var pid = target.dataset.pid;
                    var url = layList.U({ c:'special.special_type', a: 'cancel_mp_recommendation', q: { id: id, special_id: pid } });
                    $eb.$swal(
                        'delete',
                        function () {
                            $eb.axios
        ...
        return [
            ...
            {field: 'title', title: '直播标题',align: 'left',width:'10%'},
            {field: 'admin_name', title: '所属账号',align: 'center',width:'5%'},
            {field: 'subject_name', title: '分类',align: 'center',width:'5%'},
            ...
            {field: 'stream_name', title: '直播间ID',align: 'center',width:'5%'},
            ...
            {field: 'is_pink', title: '拼团状态',templet:'#is_pink',align: 'center',width:'5%'},
            {field: 'sort', title: '排序',sort: true,event:'sort',edit:'sort',align: 'center',width:'5%'},
            {field: 'is_show', title: '状态',templet:'#is_show',align: 'center',width:'5%'},
            {field: 'is_mer_visible', title: '仅会员可见',templet:'#is_mer_visible',align: 'center',width:'5%'},
        ...
        switch (event) {
            case 'delect':
                ...
                var url=layList.U({a:'recommend',q:{id:data.id}});
                    ...
                    },{title:"确认要把该直播课程推荐到首页弹窗吗?",text:'确认后无法修改',confirm:'确认'});
                break;
            case 'open_image':
