            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        {if $live_id}
                        <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('user',['live_id'=>$live_id])}',{w:800,h:700})"><i class="layui-icon layui-icon-add-1"></i> 添加嘉宾</button>
