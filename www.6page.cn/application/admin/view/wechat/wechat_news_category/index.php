                    ...
                    <div class="layui-row layui-col-space15">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group">
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="action.open_add('{:Url('append')}','添加图文消息')"><i class="layui-icon">&#xe608;</i>添加图文消息</button>
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" onclick="location.reload()"><i class="layui-icon">&#xe669;</i> 刷新</button>
                            </div>
                        </div>
                        <div>图文消息可用于公众号自动回复的图文消息选择；</div>
                        <div class="layui-col-md12">
                            <div id="news_box">
                            {volist name="list" id="vo"}
                                ...
                                {volist name="$vo['new']" id="vvo" key="k"}
                                    ...
                                    <div class="news_articel_item">
                                        <img src="{$vvo.image_input}" />
                                        <p>{$vvo.title}</p>
                                    </div>
