...
<!--                        <span class="glyphicon glyphicon-chevron-down" aria-hidden="true" @click="itemDown(index)"></span>-->
                    ...
                    <div >
                        <div  class="news-item transition news-image" :class="action==index ? 'active' :''" style="margin-bottom: 20px" @click="isShow(index)">
                            <img :src="item.image_input" style="width: 100%;height: 100%; object-fit: contain;"/>
                        </div>
                    ...
                    <form class="form-horizontal" id="signupForm">
                        ...
                        <div class="form-group">
                            <div class="col-md-12" style="margin-left: 10px;">
                                ...
                                <textarea type="text/plain" id="editor">{{newListIndex.content}}</textarea>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            that.$nextTick(function () {
                ...
                UE.registerUI('选择图片', function (editor, uiName) {
                    ...
                    that.ue = UE.getEditor('editor', {
                        toolbars: [['source', 'undo', 'redo', 'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc']],
