...
<script>
    ...
    layList.tableList('userList',"{:Url('billlist')}?category={$category}",function () {
        return [
            {field: 'uid', title: '用户ID', align: 'center',width:'6%'},
            {field: 'nickname', title: '昵称',align: 'center',width:'10%'},
            {field: 'name', title: '用户姓名',align: 'center',width:'10%'},
            {field: 'category', title: '类型',align: 'center',width:'7%'},
            {field: 'number', title: '{$gold_name}',templet:'#number',align: 'center',width:'6%'},
            {field: 'title', title: '账单标题',align: 'center',width:'10%'},
