                ...
                <div class="layui-card-body">
                    <form action="" class="layui-form">
                        <div class="layui-form-item">
                            <label class="layui-form-label required">老师分类名称：</label>
                            <div class="layui-input-block">
                                <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入老师分类名称" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">顶级老师分类：</label>
                            <div class="layui-input-block">
                        ...
                        if(parseInt(id) == 0) {
                            layList.layer.confirm('添加成功,您要继续添加分类吗?', {
                                ...
                                for (let i = parent.document.querySelectorAll('iframe').length; i--;) {
                                    if (parent.document.querySelectorAll('iframe')[i].dataset.id == '/admin/educational.teacher_categpry/index.html') {
