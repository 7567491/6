        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">班级列表</div>
                </div>
                <div class="layui-card-body">
                    <div class="layui-row layui-col-space15">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group">
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" data-type="add" onclick="action.open_add('{:Url('create')}','添加班级','100%','100%')">
                            ...
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"  onclick="action.open_add('{:Url('admin/educational.student/index')}?cid={{d.id}}','查看学员','90%','80%')">
...
<script>
    ...
    //实例化form
    layList.form.render();
    layList.date({elem: '#datetime', theme: '#10952a', type: 'datetime', range: '~', trigger: 'click'});
    //加载列表
    layList.tableList({o:'List', done:function () {}},"{:Url('getClassesList')}",function (){
        return [
            ...
            {field: 'start_time', title: '开班时间',align: 'center', width: '6%', templet: function (d) {
                return d.start_time.split(' ')[0];
            }},
            {field: 'end_time', title: '结班时间',align: 'center', width: '6%', templet: function (d) {
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            ...
            case 'open_image':
                ...
                break;
            case 'relation':
                var url="{:Url('admin/educational.classes/relation')}?id="+data.id;
                layer.open({
                    type: 2 //Page层类型
                    ,area: ['80%', '90%']
                    ,title: '关联课程'
