        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">{{id ? '编辑老师':'添加老师'}}</div>
                </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-form-item submit">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="name" style="width: 100%" v-model.trim="formData.name" autocomplete="off" placeholder="请输入老师名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item submit">
                                <label class="layui-form-label">UID：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="uid" style="width: 100%" v-model="formData.uid" autocomplete="off" disabled class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item submit">
                            ...
                            <div class="layui-form-item" style="margin-top: 10px;">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="position" style="width: 100%" v-model="formData.position" autocomplete="off" maxlength="20" placeholder="请输入老师职位" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item" style="margin-top: 10px;">
                                <label class="layui-form-label">手机号码：</label>
                                <div class="layui-input-block">
                                    <input type="text" name="phone" style="width: 100%" v-model="formData.phone" autocomplete="off" maxlength="20" placeholder="请输入手机号" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item submit">
