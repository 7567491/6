        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">学员列表</div>
                </div>
                    ...
                    <div class="layui-row layui-col-space15">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group conrelTable">
                                ...
                                <button class="layui-btn layui-btn-normal layui-btn-sm" type="button" data-type="send_test">
                                    <i class="layui-icon">&#xe609;</i>发送练习
                                </button>
                                <button class="layui-btn layui-btn-normal layui-btn-sm" type="button" data-type="send_special">
                                    <i class="layui-icon">&#xe609;</i>发送课程
                                </button>
                                <button class="layui-btn layui-btn-normal layui-btn-sm" type="button" data-type="delete_student">
                                    <i class="layui-icon">&#xe640;</i>删除学员
                                </button>
                            ...
                            <script type="text/html" id="act">
                                ...
                                <ul class="layui-nav-child layui-anim layui-anim-upbit">
                                    ...
                                    <li>
                                        <a  href="javascript:void(0)" onclick="action.open_add('{:Url('test_paper')}?type=2&uid={{d.uid}}','已发试卷')">
                                            <i class="fa fa-paste"></i> 已发试卷
                                        </a>
                                    </li>
                                    <li>
                                        <a  href="javascript:void(0)" onclick="action.open_add('{:Url('test_paper')}?type=1&uid={{d.uid}}','已发练习')">
                                            <i class="fa fa-paste"></i> 已发练习
                                        </a>
                                    </li>
                                    <li>
...
<script>
    ...
    //加载列表
    layList.tableList({o:'List', done:function () {}},"{:Url('getStudentList',['cid'=>$cid])}",function (){
        return [
            {type:'checkbox'},
        ...
        send_test:function () {
            ...
            if(ids.length){
                ...
                layer.open({
                    ...
                    ,maxmin: true //允许全屏最小化
                    ,anim: 1 //0-6的动画形式，-1不开启
                    ,content: layList.Url({c:'educational.student',a:'send_test'}),
                    btn: '确定',
                    btnAlign: 'c', //按钮居中
                    closeBtn:1,
                    yes: function(){
