...
{block name="content"}
<div id="app">
    <button class="btn btn-success  dim" data-url=""  @click="submit" type="button"><i class="fa fa-upload"></i>
    </button>
    <textarea id="myEditor" style="width:100%;height: 90%;">{$content ? $content : ''}</textarea>
</div>
