            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <form action="" class="layui-form">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">获得条件/分数：</label>
                            <div class="layui-input-block">
                                <input type="number" name="condition" v-model="formData.condition" autocomplete="off" placeholder="分数大于输入值获得" class="layui-input">
                            </div>
                        </div>
        ...
        new Vue({
            ...
            data: {
                formData:{
                    ...
                    related: related_id,
                    is_show: certificate.is_show>=0 ? certificate.is_show :  1,
                },
                certificateList: []
            },
            methods:{
                ...
                get_certificate_list: function () {
                    var that = this;
                    layList.baseGet(layList.U({a: 'certificateLists',p:{obtain:2}}), function (res) {
                ...
                save:function () {
                    ...
                    layList.loadFFF();
                    layList.basePost(layList.U({a:'certificateRecord',q:{id:id,obtain:2}}),that.formData,function (res) {
                        layList.loadClear();
