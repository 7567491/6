                ...
                <div class="layui-card-body">
                    <div class="layui-form layui-form-pane">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <label><input type="checkbox" id="all_cate" name="all_cate" lay-ignore /> 将所选分类下的全部题目添加到试卷</label>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    table.render({
        elem: '#List'
        ,url:"{:Url('admin/questions.test_paper/getTestQuestionsList')}?question_type="+question_type+'&id='+id
        ,cols: [[
            {type: 'checkbox'},
    ...
    $('#all_cate').on('change', function (e) {
        console.log($(this).prop("checked"))
        if ($(this).prop("checked")) {
            var pid = $('#pids option:selected').val()
            if (!pid) {
                layer.msg('请先选择分类');
            ...
            $.ajax({
                url: "{:Url('admin/questions.test_paper/getTestQuestionsList')}?question_type="+question_type+'&id='+id + '&pid='+pid+'&limit=100000&page=1',
                type: 'get',
