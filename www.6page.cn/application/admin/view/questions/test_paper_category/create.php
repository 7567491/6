                ...
                <div class="layui-card-body">
                    <form action="" class="layui-form">
                        <div class="layui-form-item">
                            <label class="layui-form-label required">试卷分类名称：</label>
                            <div class="layui-input-block">
                                <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入试卷分类名称" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">顶级试卷分类：</label>
                            <div class="layui-input-block">
...
{block name='script'}
<script>
    var id={$id},type={$type},cate=<?=isset($cate) ? $cate : []?>;
        ...
        new Vue({
            ...
            methods:{
                ...
                save:function () {
                    ...
                    layList.loadFFF();
                    layList.basePost(layList.U({a:'save',q:{id:id,type:type}}),that.formData,function (res) {
                        layList.loadClear();
                        if(parseInt(id) == 0) {
