        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">题库分类</div>
                </div>
                            ...
                            <form class="layui-form layui-form-pane" action="">
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        <label class="layui-form-label">题库分类名称</label>
                                        <div class="layui-input-inline">
                                            <input type="text" name="title" class="layui-input" placeholder="请输入题库分类名称">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <div class="layui-input-inline">
...
<script>
    ...
    layui.config({
        ...
        $('.layui-btn').on('click', function(event) {
            ...
            if (type === 'add') {
                $eb.createModalFrame('添加题库分类', '{:Url('create')}',{ h: 500 ,w: 800 });
