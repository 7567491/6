                    ...
                    <form action="" class="layui-form">
                        <div class="layui-form-item required">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="title" v-model.trim="formData.title" autocomplete="off" placeholder="请输入证书标题" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-row layui-col-space15">
                            <div class="layui-col-md6">
                                <div class="layui-form-item required">
                                    <label class="layui-form-label">背景图：（600*850）</label>
                                    <div class="layui-input-block">
                                        <div class="upload-image-box" v-if="formData.background" @mouseenter="mask.background = true" @mouseleave="mask.background = false">
                                            <img :src="formData.background" alt="">
                                            <div class="mask" v-show="mask.background" style="display: block">
...
<!--                                    <div class="layui-input-block">-->
<!--                                        <div class="upload-image-box" v-if="formData.qr_code" @mouseenter="mask.qr_code = true" @mouseleave="mask.qr_code = false">-->
<!--                                            <img :src="formData.qr_code" alt="">-->
<!--                                            <div class="mask" v-show="mask.qr_code" style="display: block">-->
...
<!--                                </div>-->
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea name="explain" v-model="formData.explain" autocomplete="off" maxlength="30" placeholder="最多30字" class="layui-textarea"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="layui-col-md4">
                                <img class="shili" src="{__PUBLIC_PATH}wap/images/certificate_demo.jpg">
                                <div class="download-link">
                                    <a href="{__PUBLIC_PATH}wap/images/cer-template.jpg" download="cer-template.jpg">下载证书模板（仅供参考）</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        new Vue({
            ...
            methods:{
                ...
                save:function () {
                    ...
                    if(that.formData.background=='') return layList.msg('请输入背景图');
                    layList.loadFFF();
