        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">证书列表</div>
                </div>
                <div class="layui-card-body">
                    <div class="layui-row layui-col-space15">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="title" class="layui-input" placeholder="证书名称">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-btn-group">
                                <button type="button" class="layui-btn layui-btn-normal layui-btn-sm" data-type="add" onclick="action.open_add('{:Url('add')}','添加证书')">
                                    <i class="layui-icon">&#xe608;</i>添加证书
                                </button>
                            ...
                            <script type="text/html" id="background">
                                <img style="cursor: pointer;" height="50" lay-event='open_image_background' src="{{d.background}}">
                            </script>
                            <script type="text/html" id="qr_code">
                                <img style="cursor: pointer;" height="50" lay-event='open_image_qr_code' src="{{d.qr_code}}">
                            </script>
    ...
    var action= {
        set_value: function (field, id, value) {
            layList.baseGet(layList.Url({
                a: 'set_value',
                q: {field: field, id: id, value: value, model_type: 'certificate'}
            }), function (res) {
                layList.msg(res.msg);
            });
        },
