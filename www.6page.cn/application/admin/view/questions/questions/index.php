        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">试题列表</div>
                </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" name="title" class="layui-input" placeholder="试题名称">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
...
<div id="chart-wrap" style="display: none; width: 600px; height: 300px; padding: 50px 0 0 50px;"></div>
    ...
    var action= {
        set_value: function (field, id, value) {
            layList.baseGet(layList.Url({
                a: 'set_value',
                q: {field: field, id: id, value: value, model_type: 'questions'}
            }), function (res) {
                layList.msg(res.msg);
            });
        },
