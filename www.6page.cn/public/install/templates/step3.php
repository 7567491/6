                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbname" id="dbname" value="wysj" class="input" onBlur="TestDbPwd(0)"></td>
                                <td><div id="J_install_tip_dbname"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">数据库表前缀：</td>
                                <td><input type="text" name="dbprefix" id="dbprefix" value="wy_" class="input" ></td>
                                <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个知识付费系统时需修改</span></div></td>
                            </tr>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="process_name" id="process_name" value="WYSJ_ZS" class="input"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="queue_name" id="queue_name" value="wysjQueue" class="input"></td>
                                <td><div id="J_install_rbhost"><span class="gray">多项目部署需要修改</span></div></td>
                            </tr>
                        </table>
                        <table width="100%">
