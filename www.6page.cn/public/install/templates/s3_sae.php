      ...
      <div class="server">
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="无忧速建知识付费系统" class="input"></td>
          ...
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="无忧速建" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="无忧速建网专为准备自己建网站的个人或企业而生"></td>
