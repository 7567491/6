(function (global) {
    var layList = {
        ...
        initialize: function () {
            var that = this;
            layui.use(['form', 'table', 'laydate', 'layer', 'laypage', 'upload', 'element'], function () {
    ...
    layList.msg = function (msg, successFn) {
        var msg = msg || '未知错误';
        try {
            return this.layer.msg(msg, {time: 1000}, successFn);
        } catch (e) {
            console.log(e);
        }
    }
    ...
    layList.date = function (IdName) {
        ...
        var json = typeof IdName == 'object' ? IdName : {elem: '#' + IdName, range: true, theme: '#10952a'};
