    ...
    function mapleWx(wx) {
        ...
        function _mapleApi() {
            ...
            this.init = function (config, readFn, errorFn) {
                ...
                var c2543fff3bfa6f144c2f06a7de6cd10c0b650cae = config;
                wx.config({
                    debug: c2543fff3bfa6f144c2f06a7de6cd10c0b650cae.debug || false, // 开启调试模式,调用的所有api的返回值会在客户端alert出来，若要查看传入的参数，可以在pc端打开，参数信息会通过log打出，仅在pc端时才会打印。
                    appId: c2543fff3bfa6f144c2f06a7de6cd10c0b650cae.appId, // 必填，公众号的唯一标识
                    timestamp: c2543fff3bfa6f144c2f06a7de6cd10c0b650cae.timestamp, // 必填，生成签名的时间戳
                    nonceStr: c2543fff3bfa6f144c2f06a7de6cd10c0b650cae.nonceStr, // 必填，生成签名的随机串
                    signature: c2543fff3bfa6f144c2f06a7de6cd10c0b650cae.signature,// 必填，签名，见附录1
                    jsApiList: c2543fff3bfa6f144c2f06a7de6cd10c0b650cae.jsApiList || jsApiList,// 必填，需要使用的JS接口列表，所有JS接口列表见附录2
            ...
            that.onMenuShareAll = function(options,successFn,closeFn){
                if (options && options.imgUrl) {
                    options.imgUrl = options.imgUrl.replace(/\\/g, '/');
                }
...
//                        var accuracy = res.accuracy; // 位置精度
        ...
        _mapleApi.prototype.scanQRCode = function (options, successFn) {
            ...
            wx.scanQRCode({
                ...
                scanType: options.needResult || ["qrCode", "barCode"], // 可以指定扫二维码还是一维码，默认二者都有
                success: function (res) {
