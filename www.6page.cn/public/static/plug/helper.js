(function(global,factory){
    ...
    $h.getMsgHthml=function (title,icon) {
        ...
        if(icon) html+='<img class="msg_image" src="/wap/images/msg_image/'+icon+'.png">';
    ...
    $h.U = function(opt){
        ...
        var path_map = [
            ['m','wap/index/index'],
            ['m/search','wap/index/search'],
            ['m/course','wap/special/special_cate'],
            ['m/view-course','wap/special/details'],
            ['m/single-course','wap/special/single_details'],
            ['m/single-course-txt','wap/special/single_text_detail'],
            ['m/shop','wap/store/index'],
            ['m/view-virtual','wap/special/data_details'],
            ['m/view-product','wap/store/detail'],
            ['m/my','wap/my/index'],
            ['m/teachers','wap/special/teacher_list'],
            ['m/view-teacher','wap/special/teacher_detail'],
            ['m/articles','wap/article/news_list'],
            ['m/view-article','wap/special/teacher_list'],
            ['m/lesson','wap/special/task_info'],
            ['m/lesson-txt','wap/special/task_text_info'],
            ['m/live-room','wap/live/index'],
            ['m/my-courses','wap/special/grade_special'],
            ['m/my-record','wap/special/record'],
            ['m/my-order','wap/special/order_store_list'],
            ['m/my-wrong','wap/topic/question_wrong'],
            ['m/my-topic','wap/topic/question_user'],
            ['m/my-sign','wap/my/sign_in'],
            ['m/my-vip','wap/special/member_recharge'],
            ['m/my-spread','wap/spread/spread'],
            ['m/pink-order','wap/my/order_list'],
            ['m/my-activity','wap/my/sign_list'],
            ['m/my-gift','wap/my/my_gift'],
            ['m/my-bill','wap/my/bill_detail'],
            ['m/recharge','wap/special/recharge_index'],
            ['m/my-certificate','wap/topic/certificate_list'],
            ['m/view-certificate','wap/topic/certificate_detail'],
            ['m/my-fav','wap/special/grade_list'],
            ['m/my-address','wap/my/address'],
            ['m/edit-address','wap/my/edit_address'],
            ['m/my-virtual','wap/material/my_material'],
            ['m/about','wap/my/about_us'],
            ['m/my-profile','wap/my/user_info'],
            ['m/test','wap/topic/problem_index'],
            ['m/view-test','wap/topic/problem_detail'],
            ['m/test-sheet','wap/topic/problem_sheet'],
            ['m/test-result','wap/topic/problem_result'],
            ['m/all-test','wap/topic/test_category'],
            ['m/exam','wap/special/question_index'],
            ['m/view-exam','wap/topic/question_detail'],
            ['m/exam-sheet','wap/topic/question_sheet'],
            ['m/exam-result','wap/topic/question_result'],
            ['m/all-exam','wap/topic/question_category'],
            ['m/view-wrong','wap/topic/question_detail_wrong'],
            ['m/view-certificate','wap/topic/certificate_detail'],
            ['m/view-activity','wap/my/sign_my_order'],
            ['m/nice','wap/index/unified_list'],
            ['m/pink','wap/special/group_list'],
            ['m/login','wap/login/index'],
            ['m/service','wap/service/service_list'],
        ];
        // 短链接替换
        if (is_short) {
