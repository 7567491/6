...
;(function($, window, document,undefined) {
	...
	function checkPictrue(data,baseUrl,resolve,reject){
		$.ajax({
			type : "post",
			contentType: "application/json;charset=UTF-8",
			url : baseUrl + "/captcha/index/check",
			data :JSON.stringify(data),
			cache: false,
      		crossDomain: true == !(document.all),
			success:function(res){
    ...
    Slide.prototype = {
								...
								'<div class="verifybox" style="width:'+(parseInt(this.setSize.img_width)+30)+'px">'+
									'<div class="verifybox-top">'+
										...
										'<span class="verifybox-close">'+
											'<i class="verify-iconfont verify-icon-close"></i>'+
										'</span>'+
									'</div>'+
			...
			panelHtml += '<div class="verify-img-out">'+
							'<div class="verify-img-panel">'+
								'<div class="verify-refresh" style="z-index:3">'+
									'<i class="verify-iconfont verify-icon-refresh"></i>'+
								'</div>'+
			...
			panelHtml +='<div class="verify-bar-area" style="width:'+this.setSize.img_width+',height:'+this.setSize.bar_height+',line-height:'+this.setSize.bar_height+'">'+
									...
									'<div class="verify-left-bar">'+
										...
										'<div  class="verify-move-block">'+
											'<i  class="verify-icon verify-iconfont verify-icon-right"></i>'+
        	...
        	if(this.status  && this.isEnd == false) {
				...
				checkPictrue(data,this.options.baseUrl,function(res){
					...
					if (res.repCode=="0000") {
						...
						_this.htmlDoms.icon.removeClass('verify-icon-right');
						_this.htmlDoms.icon.addClass('verify-icon-check');
						//提示框
						...
						_this.options.success({'captchaVerification':captchaVerification, 'data': data});
					}else{
						_this.htmlDoms.move_block.css('background-color', '#d9534f');
						_this.htmlDoms.left_bar.css('border-color', '#d9534f');
						_this.htmlDoms.icon.css('color', '#fff');
						_this.htmlDoms.icon.removeClass('verify-icon-right');
						_this.htmlDoms.icon.addClass('verify-icon-close');
        ...
        refresh: function() {
			...
			this.htmlDoms.icon.removeClass('verify-icon-close');
			this.htmlDoms.icon.addClass('verify-icon-right');
